...
public class EditTextAreaCell extends
  ...
  interface Template extends SafeHtmlTemplates {
    @Template("<textarea rows=\"5\" cols=\"30\" type=\"text\" tabindex=\"-1\">{0}</textarea>")
  ...
  private void editEvent(Context context, Element parent, String value,
    ...
    if (keyUp || keyDown) {
      int keyCode = event.getKeyCode();
      if (keyUp && keyCode == KeyCodes.KEY_ENTER && (event.getCtrlKey() || event.getAltKey() || event.getShiftKey())) {
        // Commit the change.
